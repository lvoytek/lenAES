...
function getHexArrayAsString(hexarr)
{
	...
	for(let i = 1; i < hexarr.length; i++)
		arrStr += "," + decimalToHexString(hexarr[i]);
...
document.addEventListener("DOMContentLoaded", function(event)
{
	...
	createUnitTestView("128-bit Key Expansion", getHexArrayAsString(keyIn), 
	...
	createUnitTestView("192-bit Key Expansion", getHexArrayAsString(keyIn), 
	...
	w = KeyExpansion(keyIn);
	createUnitTestView("256-bit Key Expansion", getHexArrayAsString(keyIn), 
